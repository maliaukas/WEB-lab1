...
public class Vector {
    ...
    /**
     * Метод, вычисляющий норму вектора {@code this}.
     *
     * @return возвращает скаляр - норму вектора {@code this}
     */
    public double norm() {
     ...
     *
     * @param v вектор, с которым вектор {@code this} проверяется на ортогональность
     ...
     *
     * @param v вектор, с которым вектор {@code this} проверяется на равенство
